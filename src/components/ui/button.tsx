  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        orange: "bg-orange text-white hover:bg-orange-light",
        minimal: "bg-white/10 text-foreground hover:bg-white/20 border border-white/30 backdrop-blur-md transition-all",
      },
      size: {
        default: "h-10 px-4 py-2 rounded-md",
        sm: "h-9 px-3 py-1 rounded-md text-xs",
        lg: "h-12 px-6 py-3 rounded-md text-base",
        xl: "h-14 px-8 py-4 rounded-lg text-lg font-semibold",
