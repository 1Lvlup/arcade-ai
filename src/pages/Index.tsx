        ...
        <section className="relative min-h-[700px] bg-background overflow-hidden">
          <div className="w-full relative z-20">
            ...
            <div className="w-full text-center mb-6 px-4 pt-2 md:pt-10 lg:pt-16">
              <h1 className="text-4xl sm:text-5xl tracking-tight text-foreground mb-4 leading-tight font-medium lg:text-5xl text-center font-tech">
              ...
              <Button onClick={handleStartGeneralChat} size="lg" variant="orange" className="text-xl font-semibold px-12 w-full sm:w-auto animate-glow-pulse hover:shadow-[0_0_35px_rgba(255,107,0,0.6)] transition-shadow duration-300">
