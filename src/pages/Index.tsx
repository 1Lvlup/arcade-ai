        ...
        <section className="relative min-h-[700px] bg-background overflow-hidden">
          <div className="w-full relative z-20">
            ...
            <div className="w-full text-center mb-6 px-4 pt-2 md:pt-10 lg:pt-16">
              ...
              <Button onClick={handleStartGeneralChat} size="lg" variant="orange" className="text-base font-semibold px-12 w-full sm:w-auto animate-glow-pulse hover:shadow-[0_0_35px_rgba(255,107,0,0.6)] transition-shadow duration-300 [-webkit-text-stroke:1px_black] [text-stroke:1px_black]">
