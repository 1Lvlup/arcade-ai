          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mt-12 sm:mt-16 lg:mt-24 max-w-5xl mx-auto">
            ...
            borderColor: 'hsl(0 0% 100% / 0.3)'
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="text-center space-y-3">
                  <div className="font-typekit font-bold text-2xl text-orange bg-[#080809]/60 rounded-xl mx-[6px]">Built With Precision  For Arcades</div>
            ...
            borderColor: 'hsl(0 0% 100% / 0.3)'
              ...
              <div className="flex flex-col items-center gap-4 sm:gap-5 lg:gap-6">
                ...
                <div className="text-center space-y-2 sm:space-y-3">
                  <div className="font-typekit font-bold text-lg sm:text-xl lg:text-2xl text-orange px-2">The More Arcades Connect, The Smarter It Gets</div>
            ...
            borderColor: 'hsl(0 0% 100% / 0.3)'
              ...
              <div className="flex flex-col items-center gap-4 sm:gap-5 lg:gap-6">
                ...
                <div className="text-center space-y-2 sm:space-y-3">
                  <div className="font-typekit font-bold text-lg sm:text-xl lg:text-2xl text-orange px-2">Real-Time Processing</div>
