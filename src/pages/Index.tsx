            ...
            borderColor: 'hsl(0 0% 100% / 0.3)'
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="text-center space-y-2 sm:space-y-3">
                  <div className="font-ethnocentric font-light text-base sm:text-lg lg:text-xl text-white px-2 text-inset">LEVEL UP</div>
                  <div className="font-ethnocentric font-light text-base sm:text-lg lg:text-xl text-orange px-2 text-inset">The first shared intelligence built for the arcade industry</div>
                </div>
              </div>
            </div>
            ...
            borderColor: 'hsl(0 0% 100% / 0.3)'
              ...
              <div className="flex flex-col items-center justify-center gap-6 h-full">
                ...
                <div className="text-center space-y-2 sm:space-y-3 px-4">
                  <div className="font-ethnocentric font-light text-base sm:text-lg lg:text-xl text-orange px-2 text-inset">Harnessing AI's capbilities to end downtime for good.</div>
                </div>
              </div>
            </div>
            <div className="feature-card p-5 sm:p-6 lg:p-7 rounded-2xl hover-glow hover-lift group" style={{
            borderColor: 'hsl(0 0% 100% / 0.3)'
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="text-center space-y-3">
                  <div className="font-ethnocentric font-light text-base sm:text-lg lg:text-xl text-orange px-2 text-inset">Every real solution strengthens the network — Creating a living database for every game, every fix</div>
                </div>
              </div>
            </div>
          </div>
